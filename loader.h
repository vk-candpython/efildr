...
#define LDR_ERR_VM           L"Unable to execute image on this machine\r\n"
#define LDR_ERR_DEBUG        L"Unable to initialize image in this environment\r\n"
#define LDR_ERR_ALLOC_IMAGE  L"Failed to allocate image memory\r\n"
#define LDR_ERR_LOADED_IMAGE L"Failed to access loaded image protocol\r\n"
...
#define CPU_RFLAGS_TF   0x0100ULL // RFLAGS Trap Flag (TF)
#define CPU_DR7_BP_MASK 0x3333ULL // DR7 L0-L3/G0-G3 enable bits
