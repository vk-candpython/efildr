...
#define LDR_ERR_FORMAT L"\r\n%s %s.\r\n"
#define LDR_ERR_PREFIX L"(efildr) [ERROR]:"
...
#define IF_EFIFAILCALL(...)      IF_EFIFAIL (EFI_CALL(__VA_ARGS__))
#define IF_EFIFAILCHAINCALL(...) IF_UNLIKE  (!EFI_CHAIN_CALL(__VA_ARGS__))
...
#define CPU_DR7_BP_MASK 0x0FFULL // DR7 L0-L3/G0-G3 enable bits (Bits 0-7)
